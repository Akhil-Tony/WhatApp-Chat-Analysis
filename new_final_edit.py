...
from new_helper import analyse
import io
#+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++

title_img=Image.open('image/header.jpg')
end_img=Image.open('image/workflow.jpg')
guide_img=Image.open('image/guideline2.jpg')
demo_img=Image.open('image/demo.jpg')
